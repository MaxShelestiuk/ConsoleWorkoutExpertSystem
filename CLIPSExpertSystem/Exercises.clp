...
(deffacts MAIN::exercise_chest
   ...
   (exercise (name Chest_Flies)(target_muscle_group Chest)(support_muscle_groups null)(equipment Dumbbells))
)
...
(deffacts MAIN::exercise_back
   ...
   (exercise (name Dumbbell_Row)(target_muscle_group Back)(support_muscle_groups Rear_Delta Biceps)(equipment Dumbbells))
)
...
(deffacts MAIN::exercise_glutes
   (exercise (name Dumbbells_Lunges)(target_muscle_group Glutes)(support_muscle_groups Quadriceps Ham_Strings)(equipment Dumbbells))
)
...
(deffacts MAIN::exercise_latetal_delta
   (exercise (name Dumbbell_Latetal_Raise)(target_muscle_group Latetal_Delta)(support_muscle_groups null)(equipment Dumbbells))
)
